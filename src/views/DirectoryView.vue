...
<template>
        ...
        <Card v-for="(doctor, index) in doctors" :key="index"
            ...
            <template #header>
                <div style="justify-items: center;">
                    <img :src="doctor.profilePhoto" :alt="doctor.profilePhoto" style="height: 400px; margin-top: 20px;"/>
                </div>
            </template>
            ...
            <template #title>
                ...
                ">
                    <h2 class="text-gray-900 font-extrabold text-2xl text-center"> 
                        {{ auxDoctor(doctor.gender) +
            ...
            <template #content>
                <div class="relative -top-5 flex flex-col gap-2">
                    <p><font-awesome-icon :icon="['fas', 'building-columns']" /> 
    ...
    <Dialog v-model:visible="visibleShow" modal style="width: 80%" maximizable>
        <template #header>
            <div class="flex align-items-center gap-2">
                ...
                <h1 style="display: inline;" class="ml-2">
                    ...
                    <font-awesome-icon :icon="['fas', 'circle-check']" v-if="showDoctor.value.verify == 'Verificado'" class="text-blue-500" />
        ...
        <p> 
            ...
            {{ showDoctor.value.speciality.join(" / ") }}
        </p>
        <p>
            <font-awesome-icon :icon="['fas', 'clock']" />
            {{ showDoctor.value.experience ? showDoctor.value.experience : 1 }} +años de experiencia
        </p>
        <p>
        ...
        <p><font-awesome-icon :icon="['fas', 'phone']" />
            <!-- REEMPLAAR POR INFORMACION REAL REAL -->
            (0000)-000 0000</p>
        <!-- RESUMEN -->
        <p><font-awesome-icon :icon="['fas', 'bookmark']" />Resumen</p>
        <p>
        ...
        <template #footer class="relative -top-5">
                <Button class="p-3" label="Agendar" icon="pi pi-calendar" iconPos="right" severity="success"
                    v-on:click="schedule(showDoctor.value.gender, showDoctor.value.name, showDoctor.value.lastname, showDoctor.value.speciality)"></Button>
        </template>
